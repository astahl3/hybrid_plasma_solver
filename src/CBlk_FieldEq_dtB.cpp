...
#if !nonadiabatic_gradPE_TERM_adiabatic_term_in_B_only
...
#endif /* #if !nonadiabatic_gradPE_TERM_adiabatic_term_in_B_only */
...
#endif /* #if NONADIABATIC_GRADPE_TERM */
...
#if !nonadiabatic_gradPE_TERM_adiabatic_term_in_PE_only
	d1_PEkappa_P  = rd[0] * (
...
#endif /* #if NONADIABATIC_GRADPE_TERM && nonadiabatic_gradPE_TERM_advance_Pe_with_B */
}
...
//       const D_REAL drain_e = 0.;
...
#if nonadiabatic_gradPE_TERM_ensure_PE_not_negative
...
#if (use_vectorclass && kappa_electron_is_2)
	...
	if(!Core_Flag[i*BlkNds_Y*BlkNds_Z +j*BlkNds_Z +k])
	{
...
#if NONADIABATIC_GRADPE_TERM && !nonadiabatic_gradPE_TERM_adiabatic_term_in_B_only
		...
		#if !nonadiabatic_gradPE_TERM_set_divUe_to_zero_DEBUG
		...
		//!------ -drain_e * PE / rho_i -----------------------------------
#if nonadiabatic_gradPE_DRAIN_TERM
...
#if nonadiabatic_gradPE_COLLISION_TERM
		...
		(
		  0.
#if nonadiabatic_gradPE_SOURCE_TERM
