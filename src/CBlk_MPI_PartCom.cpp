				  ...
				  INT32* &MPiC_Info_package)
{
	...
	//! LL updated MPI commands on 13 JUL 23
	//req_is_MPI_send_completed[id_request]
	//= mpi_myComm->IB_OR_IS_SEND(particle_package, // from .IB_OR.... to -> ND 05/04/18
	// num_particle_in_PartPackage*sizeof(particle),
	// MPI::BYTE, //PARTICLE_MPI,
	// dest_process,
	// id_package);
	MPI_Isend(particle_package,
		  num_particle_in_PartPackage*sizeof(particle),
		  MPI_BYTE,
		  dest_process,
		  id_package,
