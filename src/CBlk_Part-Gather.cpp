...
//! These exist in parameters.h now
// #define noVTH2  false
// #define getVTH2  true
   ...
   for(i = start[0]; i < end[0]; i++)
	...
	i_j_k =       i*BlkNds_Y*BlkNds_Z    +j*BlkNds_Z      +k;
      ...
      if(!collect_vth2)
		...
		{
			//! Compile-time branch optimization will keep this check from happening
			//! every loop if TRACK_PARTICLE is false, emulating the previous behavior
